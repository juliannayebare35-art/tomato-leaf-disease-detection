...
filepath = 'C:/Users/user/Desktop/PLANT_DISEASE_PROJECT/model.h5'
model = load_model(filepath)
print(model)

print("Model Loaded Successfully")

tomato_plant = cv2.imread('C:/Users/user/Desktop/PLANT_DISEASE_PROJECT/Dataset/test/Tomato___Bacterial_spot (1).JPG')
